<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Kaira Beauty.<br>
				180-182 Regent Street, India.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">+91 63551 01436</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">hy.kaira@kairabeauty.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2018 Kaira Beauty&trade;
			</div>

			<div class="developer">
				Develop by Nidhi Akbari
			</div>
